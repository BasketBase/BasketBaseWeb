...
<html lang="ES">
	<head>
		...
		<link rel="stylesheet" type="text/css" href="/BasketBaseWeb/css/ajustes/servicio/editar.css" />
		...
		<script type="text/javascript" src="/BasketBaseWeb/js/ajustes/servicio/editar.js"></script>
	</head>
	<body>
		...
		<div id="container" class="col-xs-12">
			<?php
				...
				if($row!=null){
					$qry="SELECT * FROM patrocinadores WHERE codigo=".$_GET["patro"];
			...
			?>
				<form role="form">
					<div id="nombre" class="form-group col-md-6 col-xs-12">
						...
						<?php
							echo '<input type="text" class="form-control" id="auth_nombre"
						       placeholder="Introduce el nombre" maxlength="100" value="'.$rowO['nombre'].'">';
						?>
					</div>
					<div id="url" class="form-group col-md-6 col-xs-12">
						...
						<?php
							echo '<input type="text" class="form-control" id="auth_url"
						       placeholder="Introduce el sitio web" maxlength="255" value="'.$rowO['url'].'">';
						?>
					</div>
					<div id="facebook" class="form-group col-md-6 col-xs-12">
						...
						<?php
							echo '<input type="text" class="form-control" id="auth_facebook"
						       placeholder="Introduce la url de facebook" maxlength="255" valie="'.$rowO['facebook'].'">';
						?>
					</div>
					<div id="sector" class="form-group col-md-6 col-xs-12">
						...
						<?php
							echo '<input type="text" class="form-control" id="auth_sector"
						       placeholder="Introduce el sector" maxlength="100" value="'.$rowO['sector'].'">';
						?>
					</div>
					<div id="ofertas" class="form-group col-md-6 col-xs-12">
						...
						<?php
							echo '<input type="number" class="form-control" id="auth_ofertas"
						       placeholder="Número de ofertas contratadas" value="'.$rowO['ofertas'].'">';
						?>
					</div>
					...
					<button type="submit" class="btn btn-warning editaServ">Cambiar</button>
