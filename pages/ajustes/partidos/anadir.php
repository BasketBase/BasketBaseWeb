...
<html lang="ES">
	<head>
		...
		<link rel="stylesheet" type="text/css" href="/BasketBaseWeb/css/ajustes/partidos/anadir.css" />
		...
		<script type="text/javascript" src="/BasketBaseWeb/js/ajustes/partidos/anadir.js"></script>
	</head>
	<body>
		...
		<div id="container" class="col-xs-12">
			<?php
				...
				if($row!=null){
					$qryE="SELECT nombre FROM equipos WHERE codigo=".$_GET["equipo"];
			...
			?>
				<form role="form">
					...
					<div id="rival" class="form-group col-md-6 col-xs-12">
						<label class="rival" for="rival">
							<span class="fa fa-street-view" style="margin-right: 10px"></span>
							<span>* Rival</span>
						</label>
						<input type='text' disabled class='rivalInput form-control' id="auth_rival"/>
						<button class='btn btn-primary escoEquipo'>Escoger equipo</button>
					</div>
					<div id="jornada" class="form-group col-md-6 col-xs-12">
						...
						<input type="number" placeholder='Número de jornada...' min="1" max="99" class="form-control" id="auth_jornada">
					</div>
					<div id="pabellon" class="form-group col-md-6 col-xs-12">
						...
						<input type='text' disabled class='pabellonInput form-control' id="auth_pabellon"/>
					...
					<div id="fecha" class="form-group col-md-6 col-xs-12">
						...
						<input type="text" placeholder='dd/mm/yyyy' maxlength='10' class="form-control" id="auth_fecha">
					</div>
					<div id="hora" class="form-group col-md-6 col-xs-12">
						...
						<input type="text" class="form-control" id="auth_hora" maxlength="5" placeholder="hh:MM">
					</div>
					...
					<button type="submit" class="btn btn-warning addPartido" disabled>Añadir partido</button>
				</form>
			<?php
				}
					...
					<div class="modal-body">
						...
						<table class="table table-striped table-hover table-responsive">
							...
							<tbody>
								<?php
									include "../../../php/config.php";
									$qry="SELECT codigo, nombre FROM equipos WHERE codigo!=".$_GET['equipo']." ORDER BY nombre";
