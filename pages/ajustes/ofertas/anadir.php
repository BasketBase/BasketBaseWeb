...
<html lang="ES">
	<head>
		...
		<link rel="stylesheet" type="text/css" href="/BasketBaseWeb/css/ajustes/ofertas/anadir.css" />
		...
		<script type="text/javascript" src="/BasketBaseWeb/js/ajustes/ofertas/anadir.js"></script>
	</head>
	<body>
			...
			?>
				<form role="form">
					<div id="mensaje" class="form-group col-xs-12">
						...
						<textarea type="text" class="form-control" id="auth_mensaje"
						       placeholder="Introduce el mensaje" maxlength="1000" rows="2"></textarea>
					</div>
					<div id="url" class="form-group col-md-6 col-xs-12">
						...
						<input type="text" class="form-control" id="auth_url"
						       placeholder="Introduce la dirección web..." maxlength="255">
					</div>
					<div id="fechaFin" class="form-group col-md-6 col-xs-12">
						...
						<input type="text" class="form-control" id="auth_fechaFin"
							   placeholder="Introduce la fecha de fin..." maxlength="10">
					</div>
					...
					<button type="submit" class="btn btn-warning enviarOferta" disabled>Enviar Oferta</button>
