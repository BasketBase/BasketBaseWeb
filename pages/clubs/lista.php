	...
	<body>
		...
		<div id="container" class="col-xs-12">
			<?php
				...
				echo "<div class='breadcrumbs'><a href='../clubs.php'>/</a><span>".utf8_encode($rowP['nombre'])."</span></div>";

				$consulta="SELECT * FROM clubs WHERE provincia=".$_GET["prov"]." ORDER BY nombre";
				...
				<?php
					while($rowC=mysqli_fetch_array($res)){
						echo 	"<a class='
										...
										col-sm-3
										col-xs-4'
										href='/BasketBaseWeb/pages/clubs/datos.php?club=".$rowC["codigo"]."'>
