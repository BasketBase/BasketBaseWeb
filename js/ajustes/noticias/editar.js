var codigo, titulo, subtitulo, url, cuerpo, rutaImg, tipoImg, obj_file;

$(function(){
	codigo=location.search.split('noticia=')[1];
	$("#auth_titulo").focus();
	...
	$(".editNotice").click(function(ev){
		...
		$.ajax({
	        type: 	'POST',
	        url: 	'/BasketBaseWeb/php/ajustes/noticias/editar.php',
	        data: 	"titulo="+titulo+
	        		"&codigo="+codigo+
	        		"&subtitulo="+subtitulo+
	        		"&url="+url+
	...
	$(".confirm").click(function(e){
		...
		$.ajax({
	        type: 	'POST',
	        url: 	'/BasketBaseWeb/php/ajustes/noticias/borrar.php',
	        data: 	'codigo='+codigo,
	        success:function(data){
	        	//window.location.href = "http://dev.basketbaseweb.com/pages/ajustes/club/noticias.php?club="+data;
	        	window.location.href = "http://localhost/BasketBaseWeb/pages/ajustes/club/noticias.php?club="+data;
	        },
	        error: function(data){
	        	console.log(data);
...
function setSuccess(input){
	...
	if($(".has-success").length>=1){
		$(".editNotice").prop("disabled", false);
	}
}