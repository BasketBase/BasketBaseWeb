...
$(function(){
	codigo=location.search.split('patro=')[1];
	...
	$(".enviarOferta").click(function(e){
		...
		$.ajax({
	        type: 	'POST',
	        url: 	'/BasketBaseWeb/php/ajustes/ofertas/anadir.php',
	        data: 	"patro="+codigo+
	        ...
	        ,success:function(data){
	        	if(obj_file!=null){
        			...
        			$.ajax({
				        ...
				        data: 	obj_file,
				        success:function(data){
				        	//window.location.href = "http://dev.basketbaseweb.com/pages/ajustes/ofertas/lista.php?patro="+codigo;
				        	window.location.href = "http://localhost/BasketBaseWeb/pages/ajustes/ofertas/lista.php?patro="+codigo;
...
function showError(error, input){
	...
	$(".enviarOferta").prop("disabled", true);
}
...
function setSuccess(input){
	...
	if($(".has-success").length>=1){
		$(".enviarOferta").prop("disabled", false);
	}
}
